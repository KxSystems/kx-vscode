...
describe("queryHistoryProvider", () => {
  ...
  const dummyQueryHistory: QueryHistory[] = [
    ...
    },
    {
      ...
      time: "testTime2",
      query:
        "testQuery2 ",
      success: true,
      isFromConnTree: true,
      connectionType: ServerType.KDB,
      duration: "500",
