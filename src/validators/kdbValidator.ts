...
export function validateServerAlias(input: string | undefined): string | undefined {
...
export function validateServerName(input: string | undefined): string | undefined {
  if (input !== undefined) {
    if (!validateUtils.isValidLength(input, 1, 64)) {
      return 'Input value must be between 1 and 64 alphanumeric characters in length.';
    }
...
export function validateServerPort(input: string | undefined): string | undefined {
  if (input !== undefined) {
...
export function validateServerUsername(input: string | undefined): string | undefined {
  if (input !== undefined && input !== '') {
    if (!validateUtils.isValidLength(input, 1, 64)) {
      return 'Input value must be between 1 and 64 alphanumeric characters in length.';
    }
...
export function validateServerPassword(input: string | undefined): string | undefined {
  if (input !== undefined) {
    if (!validateUtils.isValidLength(input, 1, 64)) {
      return 'Input value must be between 1 and 64 alphanumeric characters in length.';
    }
